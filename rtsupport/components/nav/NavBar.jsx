                ...
                <div className="fixed-top main-menu">
                    <div className="vertical-center px-3">
                        <ul className="nav flex-column horizontal-center">
                            ...
                            <li className="nav-item delay-2"><a className="nav-link px-2" href={`/search/${fba.uid}`}><i class="fas fa-search signout text-center mr-2"></i>SEARCH</a></li>                    
                            <li className="nav-item delay-3"><a className="nav-link px-2" href="/trending"><i class="fas fa-chart-line signout text-center mr-2"></i>TRENDING</a></li>
                            {
                                authenticated
